classdef LSL < AE5224.dubins.Path
    %LSL Dubins LSL path
    ...
    methods (Access = public)
        function obj = LSL(pa, ha, pb, hb, r)
            ...
            % Imports
            import('AE5224.dubins.util.circ_L');
            import('AE5224.dubins.util.turn_L');
            
            % Construction
            obj@AE5224.dubins.Path(pa, ha, pb, hb, r);
            obj.c0 = circ_L(obj.p0, obj.h0, obj.r);
            obj.c3 = circ_L(obj.p3, obj.h3, obj.r);
            c03 = obj.c3 - obj.c0;
            [h12, d12] = cart2pol(c03(1), c03(2));
            obj.h1 = h12;
            obj.h2 = h12;
            d01 = r * turn_L(obj.h0, obj.h1);
            d23 = r * turn_L(obj.h2, obj.h3);
            obj.d01 = d01;
            obj.d02 = obj.d01 + d12;
            obj.d03 = obj.d02 + d23;
