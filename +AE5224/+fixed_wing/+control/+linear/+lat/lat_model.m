function [A_lat, B_lat, x_lat, u_lat] = lat_model(model, x_st, u_st)
%[A_lat, B_lat, x_lat, u_lat] = LAT_MODEL(model, x_st, u_st)
%   Linearized lateral flight model
%   
%   Inputs:
...
import('AE5224.fixed_wing.control.linear.lat.xlat_to_x');
